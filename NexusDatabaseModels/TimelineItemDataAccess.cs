...
public class TimelineItemDataAccess(string connectionString) : DataAccess<TimelineItem>(connectionString, TimelineItem.Metadata)
{
    private readonly EmployeeDataAccess EmployeeDB = new(connectionString);
    private readonly ProjectDataAccess ProjectDB = new(connectionString);
    private readonly ProjectStageDataAccess ProjectStageDB = new(connectionString);
